...
{for(var i = 0, len = gdjs.JugarCode.GDMusicButtonObjects1.length ;i < len;++i) {
    gdjs.JugarCode.GDMusicButtonObjects1[i].getBehavior("Animation").setAnimationName("on");
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(15339052);
}
}
}
}
...
{gdjs.evtTools.sound.playSoundOnChannel(runtimeScene, "woosh-230554.mp3", 2, false, 100, 1);
...
}{gdjs.evtTools.sound.playSoundOnChannel(runtimeScene, "coin-recieved-230517.mp3", 3, false, 100, 1);
}}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(15343988);
}
}
if (isConditionTrue_0) {
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(15323404);
}
}
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(15325124);
}
}
}
if (isConditionTrue_0) {
...
isConditionTrue_0 = gdjs.evtTools.runtimeScene.sceneJustBegins(runtimeScene);
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("CloudTwo"), gdjs.JugarCode.GDCloudTwoObjects1);
{for(var i = 0, len = gdjs.JugarCode.GDCloudTwoObjects1.length ;i < len;++i) {
    gdjs.JugarCode.GDCloudTwoObjects1[i].getBehavior("Opacity").setOpacity(100);
}
}}
...
gdjs.copyArray(runtimeScene.getObjects("CloudTwo"), gdjs.JugarCode.GDCloudTwoObjects1);
{for(var i = 0, len = gdjs.JugarCode.GDCloudTwoObjects1.length ;i < len;++i) {
    gdjs.JugarCode.GDCloudTwoObjects1[i].setYOffset(gdjs.JugarCode.GDCloudTwoObjects1[i].getYOffset() + (gdjs.evtTools.runtimeScene.getElapsedTimeInSeconds(runtimeScene) * -(150)));
}
}}
...
{for(var i = 0, len = gdjs.JugarCode.GDcloudoOneObjects1.length ;i < len;++i) {
    gdjs.JugarCode.GDcloudoOneObjects1[i].getBehavior("Opacity").setOpacity(100);
}
}}
